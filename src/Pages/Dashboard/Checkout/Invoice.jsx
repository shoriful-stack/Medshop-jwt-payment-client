...
const Invoice = () => {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen lg:mb-12 mb-2">
                        ...
                        <tbody>
                            {purchaseDetails.items.map((item, index) => (
                                <tr key={index}>
                                    ...
                                    <td className="border px-4 py-2">{item.price} tk</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
                    <h3 className="text-xl font-semibold mt-4 flex justify-center">Total: {purchaseDetails.totalPrice} tk</h3>
                </div>
                <ReactToPrint
